...
\item \textbf{Thao tác dữ liệu thời gian thực:} AI liên tục cập nhật và điều chỉnh kho từ vựng dựa trên kết quả thực hiện nhiệm vụ và khả năng sử dụng từ thông qua các lựa chọn hội thoại.
\end{itemize}
