...
\begin{center}
    \begin{tabular}{c c c}
        ...
        \includegraphics[height=2cm]{chuky_khang.png} & 
        \includegraphics[height=2cm]{chuky_khoa.jpg} & 
        \includegraphics[height=2cm]{chuky_manh.jpg} \\[0.5cm]
        \textbf{Hà Huy Nguyên} & \textbf{Dương Thiên Phú} & \textbf{Thái Hữu Phúc} \\
        \textit{(Thành viên)} & \textit{(Thư kí)} & \textit{(Thành viên)} \\
        \includegraphics[height=2cm]{chuky_nguyen.jpg} & 
        \includegraphics[height=2cm]{chuky_phu.jpg} & 
        \includegraphics[height=2cm]{chuky_phuc.jpg} \\
    \end{tabular}
\end{center}