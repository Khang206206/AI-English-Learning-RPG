...
\end{tabularx}
\end{table}
→ Các giải pháp hiện tại hoặc là quá thiên về học thuật, thiếu bối cảnh (Duolingo), hoặc là quá tự do, thiếu cấu trúc sư phạm (Chatbot AI). Mục tiêu của dự án sẽ là trung hòa các điểm mạnh của các giải pháp trên và hạn chế các điểm yếu hiện hữu.
