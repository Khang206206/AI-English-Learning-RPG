...
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.5} % Dãn dòng cho thoáng
    \caption{Bảng Stakeholder}
    \label{tab:stakeholder}
    % Tăng cột Stakeholder lên 2.8cm, chia đều các phần còn lại
    \begin{tabular}{|L{3cm}|L{2.5cm}|L{5.5cm}|C{1.5cm}|C{1.8cm}|}
        \hline
...
Luyện viết tự do (Free Writing)& Áp dụng nguyên tắc Trừu tượng hóa để loại bỏ module phân tích văn bản tự do, tập trung tài nguyên hệ thống vào xử lý Logic cho phần Reading và Multiple-choices. & Có thể cân nhắc ở phiên bản sau (Dưới dạng ghép các block từ vựng có sẵn thành câu hoàn chỉnh, thay vì cho phép gõ phím tự do). \\ \hline
